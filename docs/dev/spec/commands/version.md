...
`cc-bash-guard version` prints build and provenance metadata for the running binary.
...
`cc-bash-guard version` should report:
...
`cc-bash-guard version --format json` should emit machine-readable metadata suitable
